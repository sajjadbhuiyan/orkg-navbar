...
const Header = () => {
  ...
  return (
    <>
        <Navbar className={header ? 'header active lg:bg-transparent menu' : 'header lg:bg-transparent menu'} expand="lg">
  <Container>
    ...
    <Navbar.Collapse id="navbarScroll">
      ...
      <Form className="d-flex mx-1">
        ...
        <Button className='px-4 mx-1 bg-black block sm:px-64' variant="dark">
